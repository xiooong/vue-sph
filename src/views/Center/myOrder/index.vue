  ...
  <div class="order-right">
              ...
              <th colspan="5">
                <span class="ordertitle"
                  ...
                  <span class="pull-right delete"
                    ><img src="@/views/Center/images/delete.png" /></span
                ></span>
              </th>
            </tr>
          </thead>
    ...
    <div class="like">
      ...
      <ul class="like-list">
        <li class="likeItem">
          <div class="p-img">
            <img src="@/views/Center/images/itemlike01.png" />
          </div>
          <div class="attr">
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/views/Center/images/itemlike02.png" />
          </div>
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/views/Center/images/itemlike03.png" />
          </div>
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/views/Center/images/itemlike04.png" />
          </div>
          <div class="attr">DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</div>
          <div class="price">
            <em>¥</em>
...
export default {
  ...
  methods: {
    async getMyOrder() {
      let result = await this.$API.reqGetOrderInfo(this.page, this.limit);
